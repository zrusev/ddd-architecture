...
namespace TimeOffManager.Infrastructure.Common.Persistence.Migrations
{
    ...
    [Migration("20200930135716_PTOBalanceMigration")]
    partial class PTOBalanceMigration
    {
            ...
            modelBuilder.Entity("TimeOffManager.Domain.Vacations.Models.Requesters.Employee", b =>
                {
                    ...
                    b.OwnsOne("TimeOffManager.Domain.Vacations.Models.Shared.PTOBalance", "PTOBalance", b1 =>
                        {
            ...
            modelBuilder.Entity("TimeOffManager.Domain.Vacations.Models.Requests.RequestDate", b =>
                {
                    ...
                    b.OwnsOne("TimeOffManager.Domain.Vacations.Models.Requests.RequestType", "RequestType", b1 =>
                        {
                            b1.Property<int>("RequestDateId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
                                .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                            ...
                            b1.HasKey("RequestDateId");

                            b1.ToTable("RequestDates");

                            b1.WithOwner()
                                .HasForeignKey("RequestDateId");
                        });
                });
